...
let addItemMenu = document.querySelector('#addItemMenu');
let menuToAddNewUser = document.querySelector('.addItem');
addItemMenu.addEventListener('click', () => {
  menuToAddNewUser.classList.toggle('show');
});
